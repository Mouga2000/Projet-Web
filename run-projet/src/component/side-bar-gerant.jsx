...
const Side_bar = () => {
    return (
            ...
            <div style={{background:'linear-gradient(290deg, #000000, #000000 ,#cfbd97)', color:"#cfbd97", width:"250px", height:'110vh', justifyContent:'center',textAlign:'center', fontFamily:'times new roman',}}>
                    ...
                    <ul style={{listStyle:'none', }}>
                        <li onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.05)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}><Link style={{color:'white'}} to = '/'> DECONNEXION</Link></li><br />
                    </ul>
