...
const Side_bar = () => {
    return (
            ...
            <div style={{background:'linear-gradient(290deg, #000000, #000000 ,#cfbd97)', color:"#cfbd97", width:"250px", height:'100vh', justifyContent:'center',textAlign:'center', fontFamily:'times new roman',}}>
                    ...
                    <ul style={{listStyle:'none', }}>
                        <li onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.05)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}><Link style={{color:'white'}} to = '/'> Acceuil</Link></li><br />
                ...
                <div style={{position:'relative', bottom:0,}}>
                    <img src={image2} className="im" alt="Logo de Zeduc-Space" style={{width: '250px', height:'100px', objectFit: 'contain',position:'relative', bottom:0, }} />
                </div>
            </div>
